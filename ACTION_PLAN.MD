...
### **AI Assistant Rules** ⚠️ CRITICAL

#### **What AI Should DO:**

-   ✅ Explain concepts and guidance
-   ✅ Show code examples in sidebar (NOT in files)
-   ✅ Help debug with questions
-   ✅ Review code on commit
-   ✅ Flag security vulnerabilities immediately
-   ✅ Suggest improvements with reasoning

#### **What AI Should NOT DO:**

-   ❌ Write code in your files (unless explicitly allowed)
-   ❌ Make decisions for you
-   ❌ Solve problems without your involvement
...
-   [ ] Set up folder structure (src/controllers, models, routes, middleware, services, utils, config)
...
-   [ ] Install and configure middleware (cors, helmet, morgan)
...
-   [ ] Install dotenv
-   [ ] Create .env file
-   [ ] Add environment variables (PORT, NODE_ENV, DATABASE_URL, JWT_SECRET)
-   [ ] Create .env.example
-   [ ] Load environment variables in server
-   [ ] Create config/env.ts for validation
...
-   [ ] Plan entity relationships (Users, Expenses, Categories, Cards, Income, Budgets, Debts, Goals)
-   [ ] Identify required fields for each entity
...
-   [ ] Define User model
-   [ ] Define Category model (with system vs custom)
-   [ ] Define Subcategory model
-   [ ] Define Card model
-   [ ] Define Expense model (with shared expense fields)
-   [ ] Define Income model
-   [ ] Define Budget model
-   [ ] Define Debt model
-   [ ] Define Goal model
...
-   [ ] Verify tables created (Prisma Studio)
-   [ ] Create database config singleton
-   [ ] Export Prisma instance

#### 1.2.5: Seed System Categories

-   [ ] Create prisma/seed.ts
-   [ ] Define system categories array (Housing, Groceries, Transport, etc.)
-   [ ] Write seed script
...
-   [ ] Implement createUser method (validate, hash password, create in DB)
...
-   [ ] Implement register method (call userService)
-   [ ] Implement login method

#### 1.3.4: Create Auth Controller

-   [ ] Create controllers/auth.controller.ts
-   [ ] Implement register handler (extract data, validate, call service, return response)
...
-   [ ] Implement authenticate middleware (extract token, verify, find user, attach to req.user)
-   [ ] Export middleware

#### 1.3.7: Create Protected Route Example

-   [ ] Create routes/user.routes.ts
-   [ ] Define GET /api/users/me (with auth middleware)
-   [ ] Create controllers/user.controller.ts
-   [ ] Implement getMe handler
...
-   [ ] Define custom error classes (AppError, ValidationError, UnauthorizedError, NotFoundError, ConflictError)
-   [ ] Implement error handler middleware (log error, return appropriate status and JSON)
-   [ ] Add as last middleware in server

#### 1.4.2: Set Up Logging

-   [ ] Install winston
-   [ ] Create utils/logger.ts
-   [ ] Configure winston (console + file transports, log levels)
-   [ ] Replace console.log with logger
-   [ ] Add request logging middleware

#### 1.4.3: Add Request Validation

-   [ ] Create middleware/validate.middleware.ts
